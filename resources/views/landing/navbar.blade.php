    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="custom-collapse">
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown">Início</a>            
          </li>
          <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Cadastro/Login</a>
            <ul class="dropdown-menu">
              <li class="dropdown"><a href="#" data-toggle="dropdown">Cadastrar</a>
                
              </li>
              <li class="dropdown"><a href="#" data-toggle="dropdown">Entrar</a>                
              </li>              
            </ul>
          </li>
        </ul>
