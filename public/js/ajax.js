...
axios.get('https://economia.awesomeapi.com.br/all/USD-BRL,EUR-BRL,GBP-BRL,ARS-BRL,BTC-BRL,LTC-BRL,ETH-BRL,XRP-BRL').then(function (response) {
  var arrayCoins = Object.values(response.data);
  var dolar = arrayCoins[0];
  var euro = arrayCoins[1];
  var libra = arrayCoins[2];
  var peso = arrayCoins[3];
  var litecoin = arrayCoins[5];
  var bitcoin = arrayCoins[4];
  var ethereum = arrayCoins[6];
  var ripple = arrayCoins[7]; //dolar
  ...
  var dolarDate = new Date(dolar.create_date);
  document.getElementById('dolarUpdate').innerHTML = dolarDate.toLocaleString();
  var dolarChange = document.getElementById('dolarChangeValue');
  dolarChange.innerHTML = '%' + dolar.pctChange; //euro
  ...
  var euroDate = new Date(euro.create_date);
  document.getElementById('euroUpdate').innerHTML = euroDate.toLocaleString();
  var euroChange = document.getElementById('euroChangeValue');
  euroChange.innerHTML = '%' + euro.pctChange; //libra
  ...
  var libraDate = new Date(libra.create_date);
  document.getElementById('libraUpdate').innerHTML = libraDate.toLocaleString();
  var libraChange = document.getElementById('libraChangeValue');
  libraChange.innerHTML = '%' + libra.pctChange; //peso
  ...
  var pesoDate = new Date(peso.create_date);
  document.getElementById('pesoUpdate').innerHTML = pesoDate.toLocaleString();
  var pesoChange = document.getElementById('pesoChangeValue');
  pesoChange.innerHTML = '%' + peso.pctChange; //litecoin

  document.getElementById('litecoinValue').innerHTML = 'R$' + litecoin.bid; //bitcoin

  document.getElementById('bitcoinValue').innerHTML = 'R$' + bitcoin.bid; //ethereum

  document.getElementById('ethereumValue').innerHTML = 'R$' + ethereum.bid; //ripple
...
module.exports = __webpack_require__(/*! C:\Users\Marcika\Desktop\Desenvolvimento\projetos\projetoTE2\resources\js\ajax.js */"./resources/js/ajax.js");
